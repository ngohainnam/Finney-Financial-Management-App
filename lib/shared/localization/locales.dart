...
mixin LocaleData {
  ...
  static const Map<String, String> bn = {
    ...
    'quizResetSuccess': 'কুইজের ফল মুছে ফেলা হয়েছে।',
    'error': 'ভুল',
    'refresh': 'রিফ্রেশ',
    'clearAllResults': 'সব ফলাফল মুছে ফেলুন',
    'learnFinanceDescription': 'ভিডিও আর কুইজ দিয়ে টাকার সহজ ধারণা বুঝে নিন।',
    ...
    coachSpendingHigh:
    "কিন্তু আপনার খরচ বেশি। অন্তত %s থেকে ১৫০ টাকা কমানোর চেষ্টা করুন।\n",
    coachSpendingMedium: "এখনও %s থেকে প্রায় ১০০ টাকা কমানোর সুযোগ আছে।\n",
    ...
    coachAdjustNo: "একটা খাবার কম খেলেও মাসে ১০০+ টাকা সেভ করা যায়।\n",
    ...
    tourDashboardTitle: 'ড্যাশবোর্ড',
    tourDashboardDesc:
    'ড্যাশবোর্ড কীভাবে ব্যবহার করবেন  আর আপনার টাকার অবস্থার জন্য দরকারি তথ্যগুলো কোথায় পাবেন, সেটা শিখে নিন।',

    tourExpenseTitle: 'এক্সপেন্স ট্র্যাকিং',
    tourExpenseDesc:
    'প্রতিদিনের খরচ কীভাবে রেকর্ড এবং পর্যবেক্ষণ করবেন তা দেখুন যাতে বেশি খরচ না হয়।',

    tourLearnHubDesc:
    'লার্নহাব এর মূল বিষয়বস্তু আর লেসনগুলো কীভাবে দেখতে হয়, তার একটা ভালো ধারণা নিয়ে নিন।',
    tourLearnhubTitle: 'লার্নহাব',
    tourLearnhubDesc:
    'লার্নহাব মডিউলগুলোর সংক্ষিপ্ত পরিচিতি এবং কিভাবে পাঠগুলো ব্যবহার করবেন তা দেখুন।',
    tourReportDesc:
    ...
    quizQ13A3: 'টাকার নিয়ম মেনে চলার অভ্যাস গড়ে তুলতে',
    ...
    quizQ17A4: 'প্রোফাইল',
    quizQ18: 'জরুরি টাকা সাধারণত কোন কাজে ব্যবহৃত হয়?',
    quizQ18A1: 'ছুটি',
    quizQ18A2: 'অপ্রত্যাশিত খরচ',
    quizQ18A3: 'বিনোদন',
    quizQ18A4: 'শপিং',
    quizQ19: 'ভালো সঞ্চয় অভ্যাস কাকে বলা হয়?',
    quizQ19A1: 'অপ্রত্যাশিত কেনাকাটা',
    ...
    quizQ26: 'আকস্মিক কেনাকাটা কমানোর উপায় কী?',
    ...
    expenseTracking: 'এক্সপেন্স ট্র্যাকিং',
    report: 'রিপোর্ট',
    savingGoals: 'সেভিং গোলস',
    quiz: 'কুইজ',
    savingMoneyEasy: 'সহজভাবে টাকা সঞ্চয়',
