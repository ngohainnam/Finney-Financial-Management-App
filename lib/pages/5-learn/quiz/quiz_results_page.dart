    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        itemBuilder: (context, index) {
          ...
          final formattedDate = formatBengaliDateTime(context, result.timestamp.toLocal());
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "${LocaleData.score.getString(context)}: ${result.score.toBn(context)} / ${result.totalQuestions.toBn(context)}",
                  style: const TextStyle(fontSize: 16, color: Colors.black87),
                ),
                Text(
                  "${LocaleData.accuracy.getString(context)}: ${result.percentageScore.toStringAsFixed(1).toBn(context)}%",
