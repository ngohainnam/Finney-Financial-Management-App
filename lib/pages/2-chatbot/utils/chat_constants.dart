...
When formatting transaction suggestions (the [AT] block), translate all content (including field names and prompts) to match the user's language.
...
English version:
  [AT] I think you want to add this transaction:
  - Amount: \$30.00
  - Name: KFC
  - Category: Food
  - Date: Apr 16, 2025
...
Bengali version:
  [AT] আপনি সম্ভবত এই লেনদেনটি যোগ করতে চান:
  - পরিমাণ: ৳৩০.০০
  - নাম: KFC
  - বিভাগ: খাবার
  - তারিখ: ১৬ এপ্রিল, ২০২৫
  - বিবরণ: KFC-তে খরচ
  তুমি কি চাও যে আমি এই লেনদেনটি তোমার রেকর্ডে যোগ করি? (হ্যাঁ/না)
